        ...
        <div class="col-xl-8">
            <div class="p-4 p-xl-5 text-white d-flex flex-column justify-content-between h-100" style="min-height: 540px;">
                <div>
                    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
                        <div class="d-inline-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="text-uppercase small fw-semibold" style="letter-spacing: 0.16em; color: rgba(191, 219, 254, 0.88);">Backend Portfolio Demo</div>
                        ...
                        <div class="rounded-pill d-inline-flex align-items-center gap-2 px-3 py-2" style="background: rgba(255,255,255,0.10); border: 1px solid rgba(255,255,255,0.12);">
                            ...
                            <span class="small fw-semibold">Ready for local demo</span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end g-4">
                        <div class="col-lg-8">
                            <h1 class="fw-bold lh-sm mb-3" style="font-size: clamp(2rem, 3.1vw, 3.6rem); max-width: 14ch;">
                                Approval workflow clear, fast, and easy to demo.
                            </h1>
                            <p class="mb-0" style="max-width: 40rem; color: rgba(226, 232, 240, 0.84); font-size: 1.05rem;">
                                A compact ERP mini system for dynamic request forms, multi-step approval, role-based access, and audit tracking using Laravel, Blade, and Bootstrap.
                            </p>
                        </div>
                        <div class="col-lg-4">
                            <div class="rounded-4 p-3 h-100" style="background: rgba(255,255,255,0.10); border: 1px solid rgba(255,255,255,0.12);">
                                <div class="small text-uppercase fw-semibold mb-2" style="letter-spacing: 0.12em; color: rgba(191, 219, 254, 0.88);">Demo Roles</div>
                                <div class="d-flex flex-wrap gap-2">
                                    <span class="badge rounded-pill px-3 py-2" style="background: rgba(255,255,255,0.12);">Admin</span>
                                    <span class="badge rounded-pill px-3 py-2" style="background: rgba(255,255,255,0.12);">Employee</span>
                                    <span class="badge rounded-pill px-3 py-2" style="background: rgba(255,255,255,0.12);">Manager</span>
                                    <span class="badge rounded-pill px-3 py-2" style="background: rgba(255,255,255,0.12);">HR</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-3 mt-4">
                    <div class="col-md-4">
                        <div class="rounded-4 p-3 h-100" style="background: rgba(255,255,255,0.10); border: 1px solid rgba(255,255,255,0.12);">
                            <div class="small text-uppercase fw-semibold mb-2" style="letter-spacing: 0.12em; color: rgba(191, 219, 254, 0.88);">Modules</div>
                            <div class="fs-2 fw-bold">06+</div>
                            <div class="small" style="color: rgba(226, 232, 240, 0.76);">Users, forms, workflow, approvals, audit logs.</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="rounded-4 p-3 h-100" style="background: rgba(255,255,255,0.10); border: 1px solid rgba(255,255,255,0.12);">
                            <div class="small text-uppercase fw-semibold mb-2" style="letter-spacing: 0.12em; color: rgba(191, 219, 254, 0.88);">Flow</div>
                            <div class="fs-2 fw-bold">3-Step</div>
                            <div class="small" style="color: rgba(226, 232, 240, 0.76);">Manager, HR, director approval chain.</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="rounded-4 p-3 h-100" style="background: rgba(255,255,255,0.10); border: 1px solid rgba(255,255,255,0.12);">
                            <div class="small text-uppercase fw-semibold mb-2" style="letter-spacing: 0.12em; color: rgba(191, 219, 254, 0.88);">Stack</div>
                            <div class="fs-2 fw-bold">Light</div>
        ...
        <div class="col-xl-4">
            <div class="h-100 p-3 p-xl-4 d-flex align-items-center justify-content-center">
                <div class="bg-white rounded-5 p-4 w-100" style="max-width: 420px; box-shadow: 0 20px 50px rgba(15, 23, 42, 0.12);">
                    <div class="mb-4">
                        <div class="text-uppercase small fw-semibold text-primary mb-2" style="letter-spacing: 0.14em;">Secure Access</div>
                        <h2 class="fw-bold mb-2" style="font-size: 1.7rem;">Login to dashboard</h2>
                        <p class="text-muted mb-0">Use the demo account below to explore the approval flow.</p>
                    </div>
                    ...
                    <div class="rounded-4 p-3 mb-4" style="background: linear-gradient(180deg, #f8fafc 0%, #eff6ff 100%); border: 1px solid rgba(148, 163, 184, 0.16);">
                        <div class="d-flex justify-content-between align-items-start gap-3">
                            <div>
                                <div class="small text-uppercase fw-semibold text-muted mb-2">Demo Account</div>
                                <div class="fw-semibold">admin@example.com</div>
                                <div class="text-muted small">password</div>
                            </div>
                            <span class="badge text-bg-primary rounded-pill px-3 py-2">Admin</span>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <span class="small text-muted">Local only</span>
                        </div>
                    ...
                    <div class="pt-3 border-top">
                        <div class="small text-muted mb-2">Demo highlights:</div>
                        <div class="d-flex flex-column gap-2 small">
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-check-circle-fill text-success"></i>
                                <span>Create dynamic request forms</span>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-check-circle-fill text-success"></i>
                                <span>Approve by role and workflow step</span>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-check-circle-fill text-success"></i>
                                <span>Track audit logs and history</span>
                            </div>
                        </div>
                    </div>
                </div>
