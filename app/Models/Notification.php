...
class Notification extends Model
{
    ...
    public const TYPE_PURCHASE_REQUEST_STOCK_READY = 'purchase_request_stock_ready';

    public const TYPE_PURCHASE_REQUEST_STOCK_FULFILLED = 'purchase_request_stock_fulfilled';
